...
SIESTA_ARCH = SIESTA 4.1 - Linux 5.4.0-42-generic x86_64 # de arcordo com o nome
...
#altere o diretorio PARA ONDE ESTA SENDO EFETUADA AS INSTLAÇÕES DAS Flags
...
#altere o diretorio "-L/usr/lib/x86_64-linux-gnu" para "-L/usr/lib/" SE FOR VERSÕES ANTERIORES A VERSÃO 17.04 DO UBUNTU ou debians parecidos

#BLACS_LIBS=/usr/lib/x86_x64-linux-gnu/libblacs-openmpi.so /usr/lib/x86_x64-linux-gnu/libblacsF77init-openmpi.so /usr/lib/x86_x64-linux-gnu/libblacsCinit-openmpi.so
#adicione SE FOR VERSÕES ANTERIORES A VERSÃO 17.04 DO UBUNTU ou debians parecidos
...
#adicione $(BLACS_LIBS) SE FOR VERSÕES ANTERIORES A VERSÃO 17.04 DO UBUNTU ou debians parecidos
